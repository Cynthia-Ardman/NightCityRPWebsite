...
export const DepositToStoreBody = zod.object({
  ...
  "memo": zod.string().max(depositToStoreBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
...
export const WithdrawFromStoreBody = zod.object({
  ...
  "memo": zod.string().max(withdrawFromStoreBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
...
export const GrantStoreBalanceBody = zod.object({
  ...
  "memo": zod.string().max(grantStoreBalanceBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
...
export const GiveToStoreBody = zod.object({
  ...
  "memo": zod.string().max(giveToStoreBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
...
export const ListMissionsResponseItem = zod.object({
  ...
  "visibility": zod.enum(['public', 'private']).optional().describe('private = visible only to fixers\/admins, the authoring fixer, and rostered players; never announced on Discord.'),
  "startAt": zod.coerce.date().nullish(),
  "npcStartAt": zod.coerce.date().nullish().describe('Optional earlier gather time for NPC actors; NPC-facing surfaces show this instead of startAt.'),
...
export const createMissionBodyVisibilityDefault = `public`;
...
export const CreateMissionBody = zod.object({
  ...
  "npcStartAt": zod.coerce.date().nullish().describe('Optional earlier gather time for NPC actors.'),
  ...
  "fixerNotes": zod.string().optional().describe('Fixer-only briefing text (visible only in the Fixer tab).'),
  "maxPlayers": zod.number().min(createMissionBodyMaxPlayersMin).default(createMissionBodyMaxPlayersDefault),
  "visibility": zod.enum(['public', 'private']).default(createMissionBodyVisibilityDefault).describe('private = visible only to fixers\/admins, the authoring fixer, and rostered players; never announced on Discord.'),
...
export const UpdateMissionBody = zod.object({
  ...
  "client": zod.string().nullish(),
  "notesForPlayers": zod.string().nullish(),
  "fixerNotes": zod.string().nullish().describe('Fixer-only briefing text (visible only in the Fixer tab).'),
...
export const ApplyToMissionBody = zod.object({
  "characterId": zod.number(),
  "comment": zod.string().nullish(),
  "availability": zod.array(zod.coerce.date()).optional().describe('When2Meet availability: absolute UTC instant strings, one per selected 30-minute block.'),
  "makeDefault": zod.boolean().optional().describe('Persist the supplied weekly pattern + timezone as this player\'s saved default.'),
  "defaultPattern": zod.array(zod.object({
  "weekday": zod.number().describe('0 = Sunday … 6 = Saturday.'),
  "minutes": zod.number().describe('Minutes from local midnight (0-1410, 30-min steps).')
})).optional().describe('Weekly availability pattern (only stored when makeDefault is true).'),
  "timezone": zod.string().nullish().describe('IANA timezone the pattern was captured in.')
})
 ...
 */
export const GetDefaultAvailabilityResponse = zod.object({
 ...
 */
export const RemoveAssignedPlayerParams = zod.object({
  "id": zod.coerce.number(),
  "userId": zod.coerce.string()
})

export const RemoveAssignedPlayerResponse = zod.object({
  "id": zod.number(),
  "title": zod.string(),
  "tier": zod.union([zod.literal(1),zod.literal(2),zod.literal(3),zod.literal(4)]),
  "status": zod.enum(['open', 'pending', 'completed', 'completed_players_paid', 'completed_paid', 'cancelled']),
...
export const CreateEventBody = zod.object({
  ...
  "npcBlurb": zod.string().nullish(),
  "recurrenceRule": zod.union([zod.object({
  "frequency": zod.number(),
  "interval": zod.number(),
  "byWeekday": zod.union([zod.array(zod.number()),zod.null()]).optional(),
  "count": zod.number().nullish(),
  "until": zod.coerce.date().nullish()
}).describe('Normalised recurrence rule (Discord). frequency: 0=yearly, 1=monthly, 2=weekly, 3=daily. byWeekday uses 0=Mon..6=Sun.'),zod.null()]).optional().describe('Recurrence rule (null = single occurrence). Only weekly (frequency=2) with interval 1-52 is supported. byWeekday, count, and until are ignored on input — the rule anchors open-ended to the start time\'s weekday.'),
...
export const UpdateEventBody = zod.object({
  ...
  "count": zod.number().nullish(),
  "until": zod.coerce.date().nullish()
}).describe('Normalised recurrence rule (Discord). frequency: 0=yearly, 1=monthly, 2=weekly, 3=daily. byWeekday uses 0=Mon..6=Sun.'),zod.null()]).optional().describe('Recurrence rule update. Omit to leave the existing rule unchanged. Null explicitly clears recurrence (also clears excludedOccurrences). Cannot be set on occurrence-scoped edits.'),
...
export const DepositToRipperdocBody = zod.object({
  ...
  "memo": zod.string().max(depositToRipperdocBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
 ...
 */
export const GiveToRipperdocParams = zod.object({
  "id": zod.coerce.number()
})


export const giveToRipperdocBodyIdempotencyKeyMax = 100;
...
export const GiveToRipperdocBody = zod.object({
  ...
  "memo": zod.string().max(giveToRipperdocBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})

export const GiveToRipperdocResponse = zod.object({
  "ok": zod.boolean(),
  "venueBalance": zod.number().describe('Venue balance after the move (unchanged when dryRun).'),
  "walletBalance": zod.number().describe('Owner personal wallet balance after the move (unchanged when dryRun).'),
  "dryRun": zod.boolean().optional().describe('True when the economy is in Test mode — nothing was written.'),
...
export const WithdrawFromRipperdocBody = zod.object({
  ...
  "memo": zod.string().max(withdrawFromRipperdocBodyMemoMax).optional().describe('Optional note attached to a player payment (giveToStore \/ giveToRipperdoc only); ignored by deposit\/withdraw\/grant.')
})
...
export const ListMySheetsResponseItem = zod.object({
  ...
  "closedOutcome": zod.union([zod.literal('approved'),zod.literal('rejected'),zod.literal('cancelled'),zod.literal(null)]).nullish().describe('For closed (archived) sheets: the resolved status at close time. Null on legacy rows where it wasn\'t recoverable.'),
...
export const ListPendingEditsResponseItem = zod.object({
  ...
  "closedOutcome": zod.union([zod.literal('approved'),zod.literal('rejected'),zod.literal('cancelled'),zod.literal(null)]).nullish().describe('For closed (archived) edits: the resolved status at close time. Null on legacy rows where it wasn\'t recoverable.'),
...
export const GetCharacterMedicalResponse = zod.object({
  ...
  "createdAt": zod.coerce.date().nullish(),
  "lastCheckupAt": zod.coerce.date().nullish(),
  "lastCheckupActualAt": zod.coerce.date().nullish().describe('Real most-recent checkup visit (newest audit row). May be later than lastCheckupAt while a checkup-reset floor event is active.'),
  "checkupStreak": zod.number(),
  "installed": zod.array(zod.object({
  "id": zod.number(),
...
export const GetUpcomingBillsResponse = zod.object({
  ...
  "lastCheckupActualAt": zod.coerce.date().nullish().describe('Real most-recent checkup visit across the household (audit trail). May be later than lastCheckupAt while a checkup-reset floor event is active.'),
...
export const ListCustomRequestsResponseItem = zod.object({
  ...
  "closedOutcome": zod.union([zod.literal('approved'),zod.literal('rejected'),zod.literal('cancelled'),zod.literal(null)]).nullish().describe('For closed (archived) requests: the resolved status at close time. Null on legacy rows where it wasn\'t recoverable.'),
  "overriddenBy": zod.string().nullish().describe('Admin user id if approved via override.'),
...
export const SubmitCustomRequestBody = zod.object({
  ...
  "imageUrl": zod.string().optional().describe('Legacy single reference image object path; ignored when imageUrls is present.'),
  "imageUrls": zod.array(zod.string()).optional().describe('Optional reference images (object paths, ordered, max 8).'),
...
export const UpdateCustomRequestBody = zod.object({
  ...
  "description": zod.string().optional(),
  "imageUrl": zod.string().optional().describe('Legacy single-image patch; ignored when imageUrls is present.'),
  "imageUrls": zod.array(zod.string()).optional().describe('Replaces the full reference-image set (max 8). Empty array clears all images.'),
 ...
 */
export const DeleteDraftCustomRequestParams = zod.object({
  "id": zod.coerce.number()
})
...
export const ListBreachPuzzlesResponseItem = zod.object({
  ...
  "difficulty": zod.enum(['easy', 'medium', 'hard', 'very_hard', 'nightmare', 'impossible']),
 ...
 */
export const getBreachPracticeStatsResponseEasyAttemptsMin = 0;

export const getBreachPracticeStatsResponseEasySolvesMin = 0;

export const getBreachPracticeStatsResponseMediumAttemptsMin = 0;

export const getBreachPracticeStatsResponseMediumSolvesMin = 0;

export const getBreachPracticeStatsResponseHardAttemptsMin = 0;

export const getBreachPracticeStatsResponseHardSolvesMin = 0;

export const getBreachPracticeStatsResponseVeryHardAttemptsMin = 0;

export const getBreachPracticeStatsResponseVeryHardSolvesMin = 0;

export const getBreachPracticeStatsResponseNightmareAttemptsMin = 0;
...
export const GetBreachPracticeStatsResponse = zod.object({
  ...
  "solves": zod.number().min(getBreachPracticeStatsResponseEasySolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "medium": zod.object({
  "attempts": zod.number().min(getBreachPracticeStatsResponseMediumAttemptsMin),
  "solves": zod.number().min(getBreachPracticeStatsResponseMediumSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "hard": zod.object({
  ...
  "very_hard": zod.object({
  "attempts": zod.number().min(getBreachPracticeStatsResponseVeryHardAttemptsMin),
  "solves": zod.number().min(getBreachPracticeStatsResponseVeryHardSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "nightmare": zod.object({
  "attempts": zod.number().min(getBreachPracticeStatsResponseNightmareAttemptsMin),
  "solves": zod.number().min(getBreachPracticeStatsResponseNightmareSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
})
 ...
 */
export const clearBreachPracticeStatsResponseEasyAttemptsMin = 0;

export const clearBreachPracticeStatsResponseEasySolvesMin = 0;

export const clearBreachPracticeStatsResponseMediumAttemptsMin = 0;

export const clearBreachPracticeStatsResponseMediumSolvesMin = 0;

export const clearBreachPracticeStatsResponseHardAttemptsMin = 0;

export const clearBreachPracticeStatsResponseHardSolvesMin = 0;

export const clearBreachPracticeStatsResponseVeryHardAttemptsMin = 0;

export const clearBreachPracticeStatsResponseVeryHardSolvesMin = 0;

export const clearBreachPracticeStatsResponseNightmareAttemptsMin = 0;
...
export const ClearBreachPracticeStatsResponse = zod.object({
  ...
  "solves": zod.number().min(clearBreachPracticeStatsResponseEasySolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "medium": zod.object({
  "attempts": zod.number().min(clearBreachPracticeStatsResponseMediumAttemptsMin),
  "solves": zod.number().min(clearBreachPracticeStatsResponseMediumSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "hard": zod.object({
  ...
  "very_hard": zod.object({
  "attempts": zod.number().min(clearBreachPracticeStatsResponseVeryHardAttemptsMin),
  "solves": zod.number().min(clearBreachPracticeStatsResponseVeryHardSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "nightmare": zod.object({
  "attempts": zod.number().min(clearBreachPracticeStatsResponseNightmareAttemptsMin),
  "solves": zod.number().min(clearBreachPracticeStatsResponseNightmareSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
})
}).describe('Per-difficulty personal practice progress for the caller.')
...
export const getBreachPracticeLeaderboardResponseMediumItemClearMsMin = 0;

export const getBreachPracticeLeaderboardResponseHardItemClearMsMin = 0;
...
export const GetBreachPracticeLeaderboardResponse = zod.object({
  ...
  "id": zod.number().describe('Unique id of this clear run (stable list key).'),
  "userId": zod.string(),
  "username": zod.string(),
  "clearMs": zod.number().min(getBreachPracticeLeaderboardResponseEasyItemClearMsMin).describe('Clear time of this individual run in ms.'),
  "achievedAt": zod.coerce.date().describe('When this run was recorded.')
}).describe('A single ranked practice clear run. A player can hold several slots.')),
  "medium": zod.array(zod.object({
  "id": zod.number().describe('Unique id of this clear run (stable list key).'),
  "userId": zod.string(),
  "username": zod.string(),
  "clearMs": zod.number().min(getBreachPracticeLeaderboardResponseMediumItemClearMsMin).describe('Clear time of this individual run in ms.'),
  "achievedAt": zod.coerce.date().describe('When this run was recorded.')
}).describe('A single ranked practice clear run. A player can hold several slots.')),
  ...
  "userId": zod.string(),
  "username": zod.string(),
  "clearMs": zod.number().min(getBreachPracticeLeaderboardResponseHardItemClearMsMin).describe('Clear time of this individual run in ms.'),
  "achievedAt": zod.coerce.date().describe('When this run was recorded.')
}).describe('A single ranked practice clear run. A player can hold several slots.')),
  "very_hard": zod.array(zod.object({
  "id": zod.number().describe('Unique id of this clear run (stable list key).'),
  "userId": zod.string(),
  "username": zod.string(),
  "clearMs": zod.number().min(getBreachPracticeLeaderboardResponseVeryHardItemClearMsMin).describe('Clear time of this individual run in ms.'),
  "achievedAt": zod.coerce.date().describe('When this run was recorded.')
}).describe('A single ranked practice clear run. A player can hold several slots.')),
  "nightmare": zod.array(zod.object({
  "id": zod.number().describe('Unique id of this clear run (stable list key).'),
  "userId": zod.string(),
  "username": zod.string(),
  "clearMs": zod.number().min(getBreachPracticeLeaderboardResponseNightmareItemClearMsMin).describe('Clear time of this individual run in ms.'),
  "achievedAt": zod.coerce.date().describe('When this run was recorded.')
}).describe('A single ranked practice clear run. A player can hold several slots.'))
...
export const recordBreachPracticeAttemptResponseEasySolvesMin = 0;

export const recordBreachPracticeAttemptResponseMediumAttemptsMin = 0;

export const recordBreachPracticeAttemptResponseMediumSolvesMin = 0;
...
export const recordBreachPracticeAttemptResponseVeryHardAttemptsMin = 0;

export const recordBreachPracticeAttemptResponseVeryHardSolvesMin = 0;
...
export const RecordBreachPracticeAttemptResponse = zod.object({
  "easy": zod.object({
  "attempts": zod.number().min(recordBreachPracticeAttemptResponseEasyAttemptsMin),
  "solves": zod.number().min(recordBreachPracticeAttemptResponseEasySolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "medium": zod.object({
  "attempts": zod.number().min(recordBreachPracticeAttemptResponseMediumAttemptsMin),
  "solves": zod.number().min(recordBreachPracticeAttemptResponseMediumSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "hard": zod.object({
  ...
  "very_hard": zod.object({
  "attempts": zod.number().min(recordBreachPracticeAttemptResponseVeryHardAttemptsMin),
  "solves": zod.number().min(recordBreachPracticeAttemptResponseVeryHardSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "nightmare": zod.object({
  "attempts": zod.number().min(recordBreachPracticeAttemptResponseNightmareAttemptsMin),
  "solves": zod.number().min(recordBreachPracticeAttemptResponseNightmareSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
})
}).describe('Per-difficulty personal practice progress for the caller.')
 ...
 */
export const mergeBreachPracticeStatsBodyStatsEasyAttemptsMin = 0;

export const mergeBreachPracticeStatsBodyStatsEasySolvesMin = 0;

export const mergeBreachPracticeStatsBodyStatsMediumAttemptsMin = 0;

export const mergeBreachPracticeStatsBodyStatsMediumSolvesMin = 0;

export const mergeBreachPracticeStatsBodyStatsHardAttemptsMin = 0;

export const mergeBreachPracticeStatsBodyStatsHardSolvesMin = 0;

export const mergeBreachPracticeStatsBodyStatsVeryHardAttemptsMin = 0;

export const mergeBreachPracticeStatsBodyStatsVeryHardSolvesMin = 0;

export const mergeBreachPracticeStatsBodyStatsNightmareAttemptsMin = 0;
...
export const MergeBreachPracticeStatsBody = zod.object({
  "stats": zod.object({
  "easy": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsBodyStatsEasyAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsBodyStatsEasySolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "medium": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsBodyStatsMediumAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsBodyStatsMediumSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "hard": zod.object({
  ...
  "very_hard": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsBodyStatsVeryHardAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsBodyStatsVeryHardSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "nightmare": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsBodyStatsNightmareAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsBodyStatsNightmareSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
})
}).describe('Per-difficulty personal practice progress for the caller.')
})

export const mergeBreachPracticeStatsResponseEasyAttemptsMin = 0;

export const mergeBreachPracticeStatsResponseEasySolvesMin = 0;

export const mergeBreachPracticeStatsResponseMediumAttemptsMin = 0;

export const mergeBreachPracticeStatsResponseMediumSolvesMin = 0;
...
export const mergeBreachPracticeStatsResponseVeryHardAttemptsMin = 0;

export const mergeBreachPracticeStatsResponseVeryHardSolvesMin = 0;
...
export const MergeBreachPracticeStatsResponse = zod.object({
  "easy": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsResponseEasyAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsResponseEasySolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "medium": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsResponseMediumAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsResponseMediumSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "hard": zod.object({
  ...
  "very_hard": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsResponseVeryHardAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsResponseVeryHardSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
}),
  "nightmare": zod.object({
  "attempts": zod.number().min(mergeBreachPracticeStatsResponseNightmareAttemptsMin),
  "solves": zod.number().min(mergeBreachPracticeStatsResponseNightmareSolvesMin),
  "fastestClearMs": zod.number().nullable().describe('Best (smallest) clear time in ms; null until first solve.')
})
}).describe('Per-difficulty personal practice progress for the caller.')
...
export const GetNcpdRecordResponse = zod.object({
  ...
  "id": zod.number(),
  "characterId": zod.number(),
  "characterName": zod.string().optional().describe('Joined character name — present on the \'my fines\' and officer list endpoints.'),
  "ownerName": zod.string().nullish().describe('Character\'s current owner display name — present on the officer list endpoint.'),
  "issuedById": zod.string().nullish(),
  "officerName": zod.string().nullish(),
 ...
 */
export const ListNcpdFinesResponseItem = zod.object({
  "id": zod.number(),
  "characterId": zod.number(),
  "characterName": zod.string().optional().describe('Joined character name — present on the \'my fines\' and officer list endpoints.'),
  "ownerName": zod.string().nullish().describe('Character\'s current owner display name — present on the officer list endpoint.'),
...
export const ListNcpdFinesResponse = zod.array(ListNcpdFinesResponseItem)
