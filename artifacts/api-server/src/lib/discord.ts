...
// Granted to the submitter when their new character sheet is approved (closed
// & materialized). Idempotent via addGuildMemberRole.
export const APPROVED_CHARACTER_ROLE_ID = "1390122462099935293";
