...
consumers read built dist/*.d.ts via TS project refs; after codegen rebuild dist, and after a `@workspace/db` schema edit `tsc --build --force` the (composite/emitDeclarationOnly) db pkg, or hooks/types show "no exported member".
