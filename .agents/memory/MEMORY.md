...
- [Breach Protocol minigame](breach-minigame.md) — exactly-once reward via atomic completedAt-IS-NULL UPDATE (item insert not idempotent); timer starts on play-page mount; /result is 200-idempotent.
