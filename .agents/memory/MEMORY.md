...
- [Mission data locations](mission-data-locations.md) — new missions/LN table never used (id seq pristine on all 3 DBs); user-facing "missions" = legacy bot mission_event imported to mission_log history.
